...
<title>Questions - TheStudybox</title>
<meta name="Keywords" content=" about,  questions , answers , follow , students , academics , subjects , maths , english , knowledge, ask questions " />
<meta name="Description" content="View a list of questions and see if there is one you can answer or ask your own question.">
...
<nav>
<ul>
<li><a href="questions.php" class="current">Questions</a></li>
...
<input type="text" name="search"  placeholder="Search" value="Search" onblur="if(this.value=='')this.value='Search'" onfocus="if(this.value=='Search')this.value=''"  placeholder="Search"  autocomplete="on"  autocomplete="on"/><input type="submit" value="" />
</form>
